...
w1 = torch.randn(3, 16, requires_grad=True)
...
for iteration in range(1, ITERATION+1):
    ...
    train_mean_crossentropy_loss = CE(train_label, train_predictions)
    ...
    with torch.no_grad():
        ...
        train_accuracy = acc(train_label, train_predictions)
        ...
        validation_mean_crossentropy_loss = CE(
            validation_label, validation_predictions)
        ...
        validation_accuracy = acc(validation_label, validation_predictions)
...
with torch.no_grad():
    ...
    test_accuracy = acc(test_label, test_predictions)
