...
w1 = torch.randn(2, 32, requires_grad=True)
...
for iteration in range(1, ITERATION+1):
    ...
    train_mse_loss = SE(train_label, train_predictions)
    ...
    with torch.no_grad():
        ...
        validation_mse_loss = SE(validation_label, validation_predictions)
...
with torch.no_grad():
    ...
    test_loss = SE(test_label, test_predictions)
